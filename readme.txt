...
- Adding custom icons from AwesomeFont

(b) CSS features

- Modified padding and margins to indent content and enhancing readability
- Modified links, text colors, and other colors to be visually appealing

(c) Advanced features

- Created a table with columns and rows
- Contact form
...
- Odin Project: https://www.theodinproject.com/lessons/foundations-git-basics
